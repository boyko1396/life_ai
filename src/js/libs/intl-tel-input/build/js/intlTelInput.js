...
var factoryOutput = (() => {
  ...
  var translateCursorPosition = (rellifentChars, formattedValue, prevCaretPos, isDeleteForwards) => {
    ...
    for (let i = 0; i < formattedValue.length; i++) {
      ...
      if (count === rellifentChars && !isDeleteForwards) {
        return i + 1;
      }
      if (isDeleteForwards && count === rellifentChars + 1) {
        return i;
      }
    }
    ...
    _initTelInputListeners() {
      ...
      this._handleInputEvent = (e) => {
        ...
        if (formatAsYouType && !userOverrideFormatting && !disableFormatOnSetNumber) {
          ...
          const rellifentCharsBeforeCaret = valueBeforeCaret.replace(/[^+0-9]/g, "").length;
          const isDeleteForwards = e?.inputType === "deleteContentForward";
          const formattedValue = this._formatNumberAsYouType();
          const newCaretPos = translateCursorPosition(rellifentCharsBeforeCaret, formattedValue, currentCaretPos, isDeleteForwards);
